...
ACCOUNT_WIDE_ACHIEVEMENT = "你所有角色的专业技能\n都将被记入本成就。";
ACCOUNT_WIDE_ACHIEVEMENT_COMPLETED = "你所有角色\n都将被记入本成就。";
ACHIEVEMENT = "成就通告";
...
ACHIEVEMENT_EARNED_BY = "赢得：|cffffffff%s|r";
ACHIEVEMENT_FILTER_ALL_EXPLANATION = "显示所有成就";
ACHIEVEMENT_FILTER_COMPLETE_EXPLANATION = "在你的账号上显示完成的成就";
...
ACTION_SPELL_AURA_BROKEN_SPELL_BUFF_FULL_TEXT = "%1$s的%5$打破了%4$s%2$s。";
...
BATTLENET_ADD_FRIEND_INFO = "使用邮箱地址添加好友时，将向对方显示你的真名名字（你将成为使命好友）。\n\n使用战网昵称添加好友时，则只向对方显示你的战网昵称。添加战网昵称好友时，你必须完整填写#号及其后面的数字。";
...
BATTLE_PETS_TOTAL_PETS_TOOLTIP = "所有坐骑";
BATTLE_PET_ABILITY_MULTIROUND = "%d回合技能";
...
BATTLE_PET_LEVEL_UP = "|H战斗宠物|h[%s]|h升到了%d级！";
BATTLE_PET_LEVEL_UP_ICON = "|T%s:0|t|H战斗宠物|h[%s]|h升到了%d级！";
...
BATTLE_TAG_REQUEST = "发送一个|cff82c5ffBattleTag|r请求给：";
...
BURNING_EMBERS = "爆燃灰烬";
BURNING_EMBERS_COST = "1 爆燃灰烬";
BURNING_EMBERS_COST_PER_TIME = "每秒%d外加%d个爆燃灰烬";
BURNING_EMBERS_COST_PER_TIME_NO_BASE = "每秒%d个爆燃灰烬";
BURNING_EMBERS_POWER = "|4Burning Ember：爆燃灰烬;";
...
CHI = "能量";
CHI_COST = "%d点能量";
CHI_COST_PER_TIME = "%d点能量，外加每秒%d点";
CHI_COST_PER_TIME_NO_BASE = "每秒%d点能量";
CHI_POWER = "真气";
...
CONFIRM_PURCHASE_TOKEN_ITEM = "你确定要将%s兑换为下列物品吗？";
...
DAMAGE_TEMPLATE_WITH_SCHOOL = "%s - %s %s点伤害";
DAMAGE_TOOLTIP = "武器伤害";
...
DEFAULT_STAT4_TOOLTIP = "法力值提高%s点\n法术爆击几率提高%.2f%%";
...
DRUID_BALANCE_CORE_ABILITY_6 = "可用时施放，同时获得太阳和月亮能量。";
...
DRUID_RESTO_CORE_ABILITY_2 = "一种快速但高效耗的治疗。";
...
DUNGEON_FLOOR_STVDIAMONDMINEBG1 = "银屑矿脉";
...
ERR_BONUS_ROLL_EMPTY = "你无权获得该首领掉落的任何战利品。你还没有支付额外拾取的费用。";
...
ERR_PETBATTLE_QUEUE_REMOVED = "获得的宠物总数。你最多可拥有500只宠物，同一种宠物最多可拥有3只。";
...
ITEM_UPGRADE = "勇气升级";
ITEM_UPGRADE_DESCRIPTION = "消耗你的勇气点数以升级一件物品等级不低于375的武器或护甲。";
...
LIGHT_FORCE = "真气";
LIGHT_FORCE_COST = "%d真气";
LIGHT_FORCE_COST_PER_TIME = "%d真气，外加每秒%d";
LIGHT_FORCE_COST_PER_TIME_NO_BASE = "每秒%d点真气";
...
LOOT_ROLL_STARTED = "|HlootHistory:%d|h[拾取]|h：%s";
...
MANA_REGEN_FROM_SPIRIT = "在战斗状态下，每5秒的法力值恢复量提高%s点";
...
MONK_MIST_CORE_ABILITY_2 = "对目标进行治疗。";
MONK_MIST_CORE_ABILITY_3 = "消耗两点真气以刷新复苏之雾。";
MONK_MIST_CORE_ABILITY_4 = "当你没有其他方法时，可用它来治疗目标。";
MONK_MIST_CORE_ABILITY_5 = "消耗60点能量让盟友为自己治疗。";
...
NO_RESPONSE = "无回复";
NO_RF_AVAILABLE = "你的当前等级没有适应的团队地下城。";
NO_RF_AVAILABLE_WITH_NEXT_LEVEL = "你的当前等级没有适应的团队地下城。下一个团队地下城可在%d级时进入。";
NO_RF_WHILE_LFD = "你无法在排队加入随机地下城时排队加入随机团队副本的队列。";
NO_RF_WHILE_LFR = "处于其他团队列表时无法加入团队副本队列。";
NO_ROLE = "没有职责";
NO_ROSTER_ACHIEVEMENT_POINTS = "-";
NO_SCENARIO_AVAILABLE = "你的当前等级没有适应的场景战役。";
NO_SCENARIO_AVAILABLE_WITH_NEXT_LEVEL = "你的当前等级没有适应的场景战役。下一个场景战役可在%d级时进入。";
...
PALADIN_HOLY_CORE_ABILITY_2 = "一种快速但高效耗的治疗。";
...
PARTY_INVITE = "邀请";
PARTY_IN_PUBLIC_GROUP_MESSAGE = "该玩家正在其他副本队伍中，无法看到小队或团队聊天信息。但你仍可以向该玩家发送密语。";
PARTY_LEADER = "小队队长";
PARTY_LEAVE = "离开队伍";
PARTY_MEMBERS = "队伍成员";
PARTY_MESSAGE = "队伍聊天";
...
PET_BATTLE_COMBAT_LOG_AURA_APPLIED = "%1s对%3s %4s施放了%2s。";
PET_BATTLE_COMBAT_LOG_AURA_FADES = "%s从%s %s身边消失了。";
PET_BATTLE_COMBAT_LOG_BLOCKED = "%s被%s %s格挡了。";
PET_BATTLE_COMBAT_LOG_DAMAGE = "%s造成了%d点伤害（目标：%s %s%s）。";
...
PET_BATTLE_FORFEIT_CONFIRMATION = "确定要放弃比赛吗？你的对手将被判定获胜。";
...
PET_BATTLE_TOOLTIP_SPEED = "决定每一回合宠物出战的次序。";
...
PET_BATTLE_TURN_CURRENT_COOLDOWN = "剩余冷却时间：%d个回合";
...
PET_JOURNAL_HELP_6 = "使用该技能恢复并治疗你的宠物。\n\n\n当该技能在冷却时，你也可以到任意城镇的兽栏管理员处使用相应服务。";
...
PET_TYPE_DEMON = "恶魔";
PET_TYPE_PET = "宠物";
PET_UNSPENT_TALENT_POINTS = "你的宠物有|cffffd200 %s |r个未选择的4talent:天赋;";
PET_WAIT = "停留";
PHONG_SHADING = "阴影平滑";
...
PLAYER_UNSPENT_TALENT_POINTS = "你有|cffffd200 %s |r个未选择的|4talent:天赋;";
PLAYER_V_PLAYER = "PvP";
...
PVP_POWER_TOOLTIP = "对玩家和他们的宠物或爪牙造成的伤害，以及在PvP区域内造成的治疗量提高。";
PVP_RANK_0_0 = "斥候";
...
REPORT_PLAYER_NAME_TEXT1 = "你可以举报违规的|cffffd200玩家名|r， |cffffd200公会名|r，或者|cffffd200竞技场队伍名|r。\n\n请选择：";
...
SHADOW_ORBS_POWER = "|4Shadow Orb：暗影宝珠;";
...
SHAMAN_RESTO_CORE_ABILITY_3 = "一种快速但高效耗的治疗。";
...
SINGLE_DAMAGE_TEMPLATE_WITH_SCHOOL = "%s %s点伤害";
...
SPECIAL = "特殊";
SPECIALIZATION = "专精";
SPECIALIZATION_PRIMARY = "主要天赋";
SPECIALIZATION_PRIMARY_ACTIVE = "主要天赋 - 生效";
SPECIALIZATION_SECONDARY = "次要天赋";
SPECIALIZATION_SECONDARY_ACTIVE = "次要天赋 - 生效";
SPECIAL_SKILLS = "%s技能：";
...
SPELL_FAILED_CANT_ADD_BATTLE_PET = "不发将小伙伴加入你的账号";
...
SPELL_FAILED_CUSTOM_ERROR_165 = "你已经从这个喂食器中抽取过树脂样本了。";
SPELL_FAILED_CUSTOM_ERROR_166 = "需要你靠近恐惧之心中的一个螳螂妖喂食器。";
...
TALENT_FRAME_HELP_2 = "当你升到更高的等级，你将解锁更多的天赋行。\n\n|cFFFF0000你可以随时访问你的职业训练师来重新分配你的天赋。|r";
...
TALENT_MICRO_BUTTON_UNSPENT_TALENTS = "你有未使用的天赋点数。";
TALENT_PASSIVE = "被动天赋";
TALENT_POINTS = "天赋";
...
TRANSMOGRIFIED = "幻化为：\n%s";
TRANSMOGRIFY = "幻化";
TRANSMOGRIFY_BIND_CONFIRMATION = "利用此物品进行幻化将使其与你绑定，并且无法退还、无法交易。";
...
TUTORIAL40 = "你学会了新的法术或技能！使用屏幕下方的|cffffd200法术书和技能按钮|r打开你的法术书。|cffffd200左键点击并拖拽|r一个法术或技能，将其移至你的动作条。|n|n法术书中的内容按先主动技能，后被动技能的顺序排列。";
...
WHC_DK_2 = "灵气已被修改。冰霜灵气现在可使符文能量的恢复速度翻倍。";
WHC_DK_3 = "某些技能现在将消耗死亡符文。";
WHC_DRUID_2 = "野性战斗专精已被拆分为基于猎豹形态的伤害输出专精——野性，以及基于熊形态的坦克专精——守护。";
WHC_DRUID_3 = "|Tinterface\\icons\\spell_nature_insectswarm.blp:16|t虫群和|Tinterface\\icons\\ability_smash.blp:16|t粉碎技能已被删除并移除出你的法术书。";
