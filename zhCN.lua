...
MONK_WIND_CORE_ABILITY_2 = "当你有1点真气时使用。";
MONK_WIND_CORE_ABILITY_3 = "当你目标的生命值低于50%时使用，以取代猛虎掌。";
MONK_WIND_CORE_ABILITY_4 = "当你有2点真气时使用。";
...
OPTION_TOOLTIP_SHOW_ACCOUNT_ACHIEVEMENTS = "打开本选项后，他人在“观察”你或使用英雄榜时，将只能看到你的角色成就。";
...
PET_BATTLE_COMBAT_LOG_DAMAGE = "%s对%s %s%s造成%d点伤害。";
...
PET_BATTLE_TOOLTIP_SPEED_ADVANTAGE = "你的速度属性较高，将在战斗中率先行动。";
...
PET_BATTLE_TURN_COOLDOWN = "%d回合冷却";
...
PET_JOURNAL_HELP_3 = "你可以在主城接受宠物对战的训练。\n\n将宠物图标拖曳到这些战斗栏位中来组建你的战队。\n\n你的宠物升级后将获得更多的技能。";
...
SHOULDERSLOT = "肩部";
SHOW = "显示";
SHOW_ACCOUNT_ACHIEVEMENTS = "只对他人显示角色成就。";
...
SPELL_FAILED_CUSTOM_ERROR_145 = "请等待玛瑙翔龙经过头顶正上方。";
