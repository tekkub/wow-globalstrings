...
CONFIRM_GLYPH_PLACEMENT_NO_COST = "你确定要嵌入这枚雕文吗？已有的雕文将被覆盖。";
...
CONFIRM_LAUNCH_URL = "点击“确定”会使你离开游戏界面并打开网络浏览器。";
...
DK_FROST_CORE_ABILITY_4 = "当你有20点符文能量时使用。";
...
DUNGEON_FLOOR_BREWMASTERSCENARIO030 = "盎迦海湾";
...
DUNGEON_FLOOR_DEATHKNELL12 = "夜行蜘蛛洞穴";
...
DUNGEON_FLOOR_MOGUSHANVAULTS3 = "不灭熔炉";
...
DUNGEON_FLOOR_SCARLETHALLS1 = "习武场";
...
ERR_PETBATTLE_DECLINED = "已拒绝宠物对战邀请。";
...
OPTION_TOOLTIP_SSAO = "控制环境光遮蔽效果的显示品质。降低此项可以大幅提高游戏运行速度。";
...
PET_BATTLE_COMBAT_LOG_AURA_APPLIED = "%s对%s %s施放了%s。";
...
PET_BATTLE_COMBAT_LOG_DEFLECT = "%s %s偏转了%s。";
PET_BATTLE_COMBAT_LOG_DODGE = "%s %s躲闪了%s。";
...
PET_BATTLE_COMBAT_LOG_HEALING = "%s为%s %s恢复了%d点生命值。";
PET_BATTLE_COMBAT_LOG_IMMUNE = "%s %s免疫%s。";
PET_BATTLE_COMBAT_LOG_MISS = "%s未命中%s %s。";
PET_BATTLE_COMBAT_LOG_NEW_ROUND = "Round %d";
PET_BATTLE_COMBAT_LOG_PAD_AURA_APPLIED = "%s对%s释放了%s。";
PET_BATTLE_COMBAT_LOG_PAD_AURA_FADES = "%s从%s中消失了。";
PET_BATTLE_COMBAT_LOG_PARRY = "%s %s招架了%s。";
PET_BATTLE_COMBAT_LOG_PET_SWITCHED = "%s现在是%s的激活宠物。";
PET_BATTLE_COMBAT_LOG_REFLECT = "%s %s反射了%s。";
PET_BATTLE_COMBAT_LOG_TRAP_HIT = "%s捕获了%s %s。";
PET_BATTLE_COMBAT_LOG_TRAP_MISS = "%s未能捕获%s %s。";
PET_BATTLE_COMBAT_LOG_WEATHER_AURA_APPLIED = "%s将气候转变为%s。";
...
PET_BATTLE_EFFECTIVENESS_VS = "对决。";
...
WHC_MONK_1 = "武僧是全新的职业。在战斗中，武僧可以扮演坦克、治疗或伤害输出的职责。绝大部分职业都可以成为武僧。";
