...
BATTLE_PETS_TOTAL_PETS_TOOLTIP = "拥有的宠物总数。你最多可拥有650只宠物，同一种宠物最多可拥有3只。";
...
LOSS_OF_CONTROL_DISPLAY_DAZE = "晕眩";
...
LOSS_OF_CONTROL_DISPLAY_INTERRUPT_SCHOOL = "%s被锁定";
...
LOSS_OF_CONTROL_DISPLAY_POSSESS = "入魔";
...
OPTION_LOSS_OF_CONTROL_INTERRUPT = "当你被打断时报警。当你的某一派系法术被锁定时，也会报警。";
...
SPELL_FAILED_CUSTOM_ERROR_178 = "需要流火、丛林啤酒花或灵吻之水";
