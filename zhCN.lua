...
BLIZZARD_STORE_LICENSE_ACK_TEXT = "用户确认：本人已阅读并理解本协议中的所有条款并确认购买。\n|HurlIndex:8|h|cff71d5ff退款条例|r|h，|HurlIndex:9|h|cff71d5ff交易条款|r|h";
BLIZZARD_STORE_LICENSE_ACK_TEXT_CN = "您将通过战网点数购买虚拟物品，一旦点击“立即购买”按钮，战网点数将被立即扣除，且不能退还。确定要购买吗？";
BLIZZARD_STORE_LICENSE_ACK_TEXT_TW = "您将通过账户余额购买虚拟物品。如果您的余额不足，请访问战网账号管理页面。点击“立即购买”，即默认您同意|HurlIndex:10|h|cff71d5ff交易条款|r|h";
...
BLIZZARD_STORE_PURCHASE_COMPLETE = "您所购买的商品已发送！";
BLIZZARD_STORE_PURCHASE_COMPLETE_DESC = "您购买的物品已经发送。";
