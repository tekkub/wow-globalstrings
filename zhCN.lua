...
ERR_PETBATTLE_GAME_ROUNDS_LIMIT_WARNING = "达到宠物对战回合上限——将在%d回合后结束";
...
MONK_MIST_CORE_ABILITY_5 = "消耗60点能量，为靠近疗伤珠的盟友恢复生命值。";
MONK_WIND_CORE_ABILITY_1 = "用于生成真气。";
MONK_WIND_CORE_ABILITY_2 = "在没有其他方法时使用。";
...
PLAYER_UNSPENT_TALENT_POINTS = "你有|cffffd200 %s |r个未选择的|天赋;";
PLAYER_V_PLAYER = "PvP";
...
WHC_DK_2 = "灵气已被修改。|Tinterface\\icons\\spell_deathknight_frostpresence.blp:16|t|cff71d5ff|Hspell:48266|h[冰霜灵气]|h|r现在可使符文能量的生成速度翻倍。";
