...
BLOCK_CHANCE = "格挡几率";
BLOCK_CHAT_CHANNEL_INVITE = "阻止聊天频道邀请|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
COMBAT_LABEL = "战斗|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
COMBAT_LOG = "战斗记录";
...
SHOW_TARGET_CASTBAR_IN_V_KEY = "姓名板|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
