...
BATTLE_PETS_TOTAL_PETS_TOOLTIP = "获得的宠物总数。你最多可拥有500只宠物，同一种宠物最多可拥有3只。";
...
MANA_REGEN_FROM_SPIRIT = "在战斗状态下，每5秒的法力值恢复量提高%d点";
...
PVP_POWER_TOOLTIP = "提高在PvP区域内的治疗量以及对玩家和他们的宠物或爪牙造成的伤害。";
PVP_RANK_0_0 = "斥候";
