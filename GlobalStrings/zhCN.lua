...
BINDING_HEADER_TARGETING = "选中目标按键";
...
BLIZZARD_CHALLENGE_CONNECTING = "正在校验……";
...
BLIZZARD_CHALLENGE_SCREEN_EXPLANATION = "只有暴雪发送的官方信息请求才会将画面变成蓝底白线的效果！";
...
BLIZZARD_STORE_PAGE_NUMBER = "%d/%d 页";
...
BROWSER_CACHE_CLEARED = "你已清理了缓存。";
BROWSER_CLEAR_CACHE = "清理缓存";
BROWSER_CLEAR_CACHE_TOOLTIP = "该操作将清除浏览器缓存。";
BROWSER_COOKIES_DELETED = "你已清理了cookie。";
...
DK_BLOOD_CORE_ABILITY_3 = "当你有1个鲜血符文时使用。";
DK_BLOOD_CORE_ABILITY_4 = "当你有1个冰霜符文和1个邪恶符文时使用，以治疗自己。";
DK_BLOOD_CORE_ABILITY_5 = "当你有30点符文能量时使用。";
DK_FROST_CORE_ABILITY_1 = "当你有1个邪恶符文时使用。";
DK_FROST_CORE_ABILITY_2 = "当你有1个冰霜符文时使用。";
DK_FROST_CORE_ABILITY_3 = "当你有1个冰霜符文和1个邪恶符文时使用。";
DK_FROST_CORE_ABILITY_4 = "当你有可用的符文能量时使用。";
DK_UNHOLY_CORE_ABILITY_1 = "当你有1个邪恶符文时使用。";
DK_UNHOLY_CORE_ABILITY_2 = "当你有1个冰霜符文时使用。";
DK_UNHOLY_CORE_ABILITY_3 = "当你有1个邪恶符文时使用。";
DK_UNHOLY_CORE_ABILITY_4 = "当你有1个鲜血符文和1个冰霜符文时使用。";
DK_UNHOLY_CORE_ABILITY_5 = "当可用时变形你的食尸鬼。";
DK_UNHOLY_CORE_ABILITY_6 = "当你有40点符文能量时使用。";
DMG = "Dmg";
DND = "忙碌";
DODGE = "躲闪";
DODGE_CHANCE = "躲闪几率";
...
DRUID_BALANCE_CORE_ABILITY_1 = "被动。达到100点太阳或月亮能量，可提高你的伤害。";
DRUID_BALANCE_CORE_ABILITY_2 = "可用时，持续施加在目标身上。";
DRUID_BALANCE_CORE_ABILITY_3 = "可用时，持续施加在目标身上。";
DRUID_BALANCE_CORE_ABILITY_4 = "当你需要月亮能量时施放。";
DRUID_BALANCE_CORE_ABILITY_5 = "当你需要太阳能量时施放。";
DRUID_BALANCE_CORE_ABILITY_6 = "可用时施放，可使你获得太阳能量或月亮能量。";
DRUID_FERAL_CORE_ABILITY_1 = "当你在目标身后时使用，以积累连击点数。";
DRUID_FERAL_CORE_ABILITY_2 = "用于当你无法站到目标身后时积累连击点数。";
DRUID_FERAL_CORE_ABILITY_3 = "持续施加在目标身上。";
DRUID_FERAL_CORE_ABILITY_4 = "当你有5个连击点数时，持续施加在自己身上。";
DRUID_FERAL_CORE_ABILITY_5 = "当你有5个连击点数时使用。主要的终结技。";
DRUID_FERAL_CORE_ABILITY_6 = "当你目标的生命值低于25%时使用。";
DRUID_GUARDIAN_CORE_ABILITY_1 = "持续施加在目标身上。";
DRUID_GUARDIAN_CORE_ABILITY_2 = "持续施加在目标身上。";
DRUID_GUARDIAN_CORE_ABILITY_3 = "可用时使用。是主要的怒气生成手段。";
DRUID_GUARDIAN_CORE_ABILITY_4 = "当你有60点怒气时持续施加在自己身上，用于防御。";
DRUID_GUARDIAN_CORE_ABILITY_5 = "当你有60点怒气时使用以治疗自己。";
DRUID_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
DRUID_RESTO_CORE_ABILITY_1 = "持续施加在目标身上以进行治疗。";
DRUID_RESTO_CORE_ABILITY_2 = "一种快速但高消耗的治疗。";
DRUID_RESTO_CORE_ABILITY_3 = "一种低消耗的治疗。";
DRUID_RESTO_CORE_ABILITY_4 = "一种强效治疗。";
DRUID_RESTO_CORE_ABILITY_5 = "持续施加在目标身上以进行治疗。";
DRUID_RESTO_CORE_ABILITY_6 = "频繁对目标使用，以快速治疗。";
...
HUNTER_BM_CORE_ABILITY_1 = "持续施加在目标身上。";
HUNTER_BM_CORE_ABILITY_2 = "可用时使用。";
HUNTER_BM_CORE_ABILITY_3 = "当没有其它技能可用时使用。";
HUNTER_BM_CORE_ABILITY_4 = "当你的集中值较低时使用。";
HUNTER_BM_CORE_ABILITY_5 = "当你目标的生命值低于20%时使用。";
HUNTER_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
HUNTER_MM_CORE_ABILITY_1 = "持续施加在目标身上。";
HUNTER_MM_CORE_ABILITY_2 = "当狙击高手出现时使用。";
HUNTER_MM_CORE_ABILITY_3 = "可用时使用。";
HUNTER_MM_CORE_ABILITY_4 = "当没有其它技能可用时使用。";
HUNTER_MM_CORE_ABILITY_5 = "当你的集中值较低时使用。";
HUNTER_MM_CORE_ABILITY_6 = "当你目标的生命值低于20%时使用。";
...
HUNTER_SV_CORE_ABILITY_6 = "当你目标的生命值低于20%时使用。";
...
ITEM_UPGRADE_DESCRIPTION = "消耗你的荣誉、正义、征服勇气点数以升级一件物品等级不低于458的武器或护甲。";
...
MAGE_ARCANE_CORE_ABILITY_1 = "被动。使你的伤害和施法所消耗的法力值提高。";
MAGE_ARCANE_CORE_ABILITY_2 = "主要的伤害法术。奥术充能的主要手段。";
MAGE_ARCANE_CORE_ABILITY_3 = "可用时施放。";
MAGE_ARCANE_CORE_ABILITY_4 = "当你累积了4层奥术充能或当施法消耗过高时使用。";
MAGE_FIRE_CORE_ABILITY_1 = "主要的伤害法术。";
MAGE_FIRE_CORE_ABILITY_2 = "当你的目标正在燃烧，且可用时使用。";
MAGE_FIRE_CORE_ABILITY_3 = "当你的目标正在燃烧，且可用时使用。";
MAGE_FIRE_CORE_ABILITY_4 = "当炎爆术出现时使用。";
MAGE_FROST_CORE_ABILITY_1 = "主要的伤害法术。";
MAGE_FROST_CORE_ABILITY_2 = "当冰冷智慧出现时使用。";
...
MONK_BREW_CORE_ABILITY_2 = "在可用时消耗两点真气以减少伤害。";
MONK_BREW_CORE_ABILITY_3 = "消耗两点真气以减少伤害。";
MONK_BREW_CORE_ABILITY_4 = "消耗20点能量以减少伤害。";
MONK_BREW_CORE_ABILITY_5 = "消耗两点真气以造成伤害。";
MONK_MIST_CORE_ABILITY_1 = "一次迅速但代价高昂的治疗。";
MONK_MIST_CORE_ABILITY_2 = "持续施加在目标身上以进行治疗。";
MONK_MIST_CORE_ABILITY_3 = "当多个盟友身上带有复苏之雾效果时使用。";
MONK_MIST_CORE_ABILITY_4 = "当你没有其他方法时，可用它来治疗目标。";
MONK_MIST_CORE_ABILITY_5 = "放置在地上，为靠近的盟友恢复生命值。";
MONK_WIND_CORE_ABILITY_1 = "用于生成真气。";
MONK_WIND_CORE_ABILITY_2 = "当没有其它技能可用时使用。";
MONK_WIND_CORE_ABILITY_3 = "当你拥有2点真气时使用。";
MONK_WIND_CORE_ABILITY_4 = "可用时使用。";
MONK_WIND_CORE_ABILITY_5 = "当你受伤且有40点能量时使用。";
MONK_WIND_CORE_ABILITY_6 = "当你有3点真气时使用。";
...
OPTION_TOOLTIP_AUTO_QUEST_WATCH = "在你接到一个带有可追踪目标的任务时，自动开始追踪这个任务，并在你达成一个目标后持续显示5分钟。";
...
PALADIN_HOLY_CORE_ABILITY_2 = "一种快速但高消耗的治疗。";
PALADIN_HOLY_CORE_ABILITY_3 = "一种低消耗的治疗。";
PALADIN_HOLY_CORE_ABILITY_4 = "一种强效治疗。";
PALADIN_HOLY_CORE_ABILITY_5 = "当你有3点神圣能量时使用，用于治疗。";
PALADIN_HOLY_CORE_ABILITY_6 = "用于同时治疗2个目标。";
...
PALADIN_PROT_CORE_ABILITY_5 = "当没有其它技能可用时使用。";
PALADIN_PROT_CORE_ABILITY_6 = "当你累积了3点神圣能量时使用，用于伤害和防御，并强化你的荣耀圣令。";
PALADIN_RET_CORE_ABILITY_1 = "可用时使用。用于生成1点神圣能量。";
PALADIN_RET_CORE_ABILITY_2 = "可用时使用。用于生成1点神圣能量。";
PALADIN_RET_CORE_ABILITY_3 = "当战争艺术出现时使用。";
PALADIN_RET_CORE_ABILITY_4 = "当你有3点神圣能量时，持续施加在自己身上。";
PALADIN_RET_CORE_ABILITY_5 = "当你有3点神圣能量时使用。";
PALADIN_RET_CORE_ABILITY_6 = "当你目标的生命值低于20%时使用。";
...
PRIEST_DISC_CORE_ABILITY_3 = "一种快速但高消耗的治疗。";
PRIEST_DISC_CORE_ABILITY_4 = "一种低消耗的治疗。";
PRIEST_DISC_CORE_ABILITY_5 = "一种强效治疗。";
PRIEST_DISC_CORE_ABILITY_6 = "一种瞬发但高消耗的伤害吸收效果。";
PRIEST_HOLY_CORE_ABILITY_1 = "可用时使用。";
PRIEST_HOLY_CORE_ABILITY_2 = "持续施加在目标身上以进行治疗。";
PRIEST_HOLY_CORE_ABILITY_3 = "一种快速但高消耗的治疗。";
PRIEST_HOLY_CORE_ABILITY_4 = "一种低消耗的治疗。";
PRIEST_HOLY_CORE_ABILITY_5 = "一种强效治疗。";
PRIEST_HOLY_CORE_ABILITY_6 = "用于切换单体治疗、群体治疗或伤害。";
...
PRIEST_SHADOW_CORE_ABILITY_6 = "当你目标的生命值低于20%时使用。";
PRIMARY = "主要";
PRIMARY_MONITOR = "显示器";
PRIMARY_SKILLS = "主要技能：";
PRIME_GLYPH = "首要雕文";
...
PROFESSIONS_USED_IN_COOKING = "烹饪材料";
...
PVP_ARENA_NEED_LESS = "要加入该竞技场，你的团队需要减少%d名玩家。";
PVP_ARENA_NEED_MORE = "要加入该竞技场，你的团队需要增加%d名玩家。";
...
PVP_POWER_TOOLTIP = "提高在PvP和户外区域的治疗量以及对玩家和他们的宠物或爪牙造成的伤害。";
PVP_RANK_0_0 = "斥候";
...
QUEST_PLAYERS_DEFEATED_PET_BATTLE = "在宠物战斗中失利的玩家：%d/%d";
QUEST_PLAYERS_DEFEATED_PET_BATTLE_NOPROGRESS = "在宠物战斗x %d中失利的玩家";
...
QUEUED_STATUS_LOCKED_EXPLANATION = "你已被锁定在该评级战场，直至其结束。";
...
RAF_REWARD_SUPPRESSED = "你已获得了%d种奖励，但仍可能出现新选择。请在新的可选奖励出现后再查看！";
...
ROGUE_ASS_CORE_ABILITY_1 = "当你有55点能量值时使用，以生成2个连击点数。是主要的连击点数生成手段。";
ROGUE_ASS_CORE_ABILITY_2 = "当你有5个连击点数时，持续施加在目标身上。";
ROGUE_ASS_CORE_ABILITY_3 = "当你有5个连击点数时，持续施加在自己身上。";
ROGUE_ASS_CORE_ABILITY_4 = "当你有5个连击点数时使用，以造成伤害。是主要的终结技。";
ROGUE_ASS_CORE_ABILITY_5 = "当你目标的生命值低于35%或盲点出现时使用，以生成1个连击点数。";
ROGUE_COMBAT_CORE_ABILITY_1 = "当你有40点能量值时使用，以生成1个连击点数。是主要的连击点数生成手段。";
ROGUE_COMBAT_CORE_ABILITY_2 = "持续施加在目标身上。";
ROGUE_COMBAT_CORE_ABILITY_3 = "当你有5个连击点数时，持续施加在自己身上。";
ROGUE_COMBAT_CORE_ABILITY_4 = "当你有5个连击点数时使用，以造成伤害。是主要的终结技。";
ROGUE_SUB_CORE_ABILITY_1 = "当你位于目标身后时使用，以生成1个连击点数。是主要的连击点数生成手段。";
ROGUE_SUB_CORE_ABILITY_2 = "当你无法站到目标身后时使用，以生成1个连击点数。";
ROGUE_SUB_CORE_ABILITY_3 = "当你有5个连击点数时，持续施加在目标身上。";
ROGUE_SUB_CORE_ABILITY_4 = "当你有5个连击点数时，持续施加在自己身上。";
ROGUE_SUB_CORE_ABILITY_5 = "当你有5个连击点数时使用，以造成伤害。是主要的终结技。";
ROLE = "职责";
...
SHAMAN_ELE_CORE_ABILITY_2 = "持续施加在自己身上。";
SHAMAN_ELE_CORE_ABILITY_3 = "当你有7层闪电之盾时施放。";
SHAMAN_ELE_CORE_ABILITY_4 = "可用时使用。";
SHAMAN_ELE_CORE_ABILITY_5 = "当没有其它技能可用时使用。";
SHAMAN_ENHANCE_CORE_ABILITY_1 = "持续施加在目标身上。";
SHAMAN_ENHANCE_CORE_ABILITY_2 = "可用时使用。";
SHAMAN_ENHANCE_CORE_ABILITY_3 = "可用时使用。";
SHAMAN_ENHANCE_CORE_ABILITY_4 = "当漩涡武器出现时施放。";
SHAMAN_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
SHAMAN_RESTO_CORE_ABILITY_1 = "持续施加在目标身上。";
SHAMAN_RESTO_CORE_ABILITY_2 = "可用时使用以治疗目标。";
SHAMAN_RESTO_CORE_ABILITY_3 = "一种快速但高消耗的治疗。";
SHAMAN_RESTO_CORE_ABILITY_4 = "一种低消耗的治疗。";
SHAMAN_RESTO_CORE_ABILITY_5 = "一种强效治疗。";
...
STAT_MASTERY = "精通";
STAT_MASTERY_TOOLTIP = "%d点精通（+%.2f%%精通）。";
...
VRN_WINDOWS_32BIT = "需要64位版本的Windows系统。";
...
WARLOCK_AFFLICTION_CORE_ABILITY_4 = "当上述法术被施加在目标身上时使用。";
WARLOCK_AFFLICTION_CORE_ABILITY_5 = "当目标的生命值较低时使用。";
WARLOCK_AFFLICTION_CORE_ABILITY_6 = "当你有灵魂碎片时使用。";
WARLOCK_DEMO_CORE_ABILITY_1 = "被动。由你的法术或恶魔攻击生成。";
WARLOCK_DEMO_CORE_ABILITY_2 = "持续施加在目标身上。";
WARLOCK_DEMO_CORE_ABILITY_3 = "持续施加在目标身上。";
WARLOCK_DEMO_CORE_ABILITY_4 = "当没有其它技能可用时使用。";
WARLOCK_DEMO_CORE_ABILITY_5 = "当熔火之心出现时使用。";
WARLOCK_DEMO_CORE_ABILITY_6 = "当你的恶魔之怒达到最大值时，变身为恶魔。";
WARLOCK_DESTRO_CORE_ABILITY_1 = "被动。由烧尽和邪焰生成。";
WARLOCK_DESTRO_CORE_ABILITY_2 = "持续施加在目标身上。";
WARLOCK_DESTRO_CORE_ABILITY_3 = "使用以加快烧尽的施法速度。";
WARLOCK_DESTRO_CORE_ABILITY_4 = "施放以生成爆燃灰烬。";
WARLOCK_DESTRO_CORE_ABILITY_5 = "当你有爆燃灰烬时施放。";
WARLOCK_DESTRO_CORE_ABILITY_6 = "当你目标的生命值低于20%时施放。";
WARLOCK_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
WARRIOR_ARMS_CORE_ABILITY_1 = "使用以拉近你和目标之间的距离。";
WARRIOR_ARMS_CORE_ABILITY_2 = "可用时使用，让你的目标承受更多伤害。";
WARRIOR_ARMS_CORE_ABILITY_3 = "可用时使用。是主要的怒气生成手段。";
WARRIOR_ARMS_CORE_ABILITY_4 = "可用时使用。";
WARRIOR_ARMS_CORE_ABILITY_5 = "每当你有30点怒气时使用。";
WARRIOR_ARMS_CORE_ABILITY_6 = "当你目标的生命值低于20%时使用。";
WARRIOR_FURY_CORE_ABILITY_1 = "使用以拉近你和目标之间的距离。";
WARRIOR_FURY_CORE_ABILITY_2 = "可用时使用。是主要的怒气生成手段。";
WARRIOR_FURY_CORE_ABILITY_3 = "当被激怒时使用。";
WARRIOR_FURY_CORE_ABILITY_4 = "每当你有30点怒气时使用。";
WARRIOR_FURY_CORE_ABILITY_5 = "当你目标的生命值低于20%时使用。";
WARRIOR_PROT_CORE_ABILITY_1 = "使用以拉近你和目标之间的距离。";
WARRIOR_PROT_CORE_ABILITY_2 = "可用时使用。是主要的怒气生成手段。";
WARRIOR_PROT_CORE_ABILITY_3 = "可用时使用。";
WARRIOR_PROT_CORE_ABILITY_4 = "当没有其它技能可用时使用。";
WARRIOR_PROT_CORE_ABILITY_5 = "当你有60点怒气时使用，用于防御。";
