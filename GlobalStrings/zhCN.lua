...
BINDING_NAME_TOGGLEDUNGEONSANDRAIDS = "开启/关闭地下城和团队副本窗口";
...
BINDING_NAME_TOGGLEGARRISONLANDINGPAGE = "开启/关闭要塞报告";
BINDING_NAME_TOGGLEGRAPHICSSETTINGS = "开启/关闭画质设定";
BINDING_NAME_TOGGLEGROUPFINDER = "开启/关闭队伍查找器";
...
BINDING_NAME_TOGGLETOYBOX = "开启/关闭玩具盒";
...
CANNOT_DO_THIS_IN_BATTLEGROUND = "你不能在排队时，或在战场或竞技场中那样做。";
CANNOT_DO_THIS_IN_LFG_PARTY = "你不能在自动匹配队伍中那样做。";
CANNOT_DO_THIS_IN_PVE_QUEUE = "你不能在地下城、团队地下城或场景战役队列中那样做。";
...
CAPACITANCE_INCREASED_CAPACITY_TOOLTIP = "你可以通过升级此建筑或仓库来提高工作指令的产能。";
...
CLASS_ROLES = "职业角色";
CLASS_SKILLS = "%s技能：";
CLEAN_UP_BAGS_TUTORIAL = "点击该按钮整理你的背包。|n|n它将自动对物品进行整理，并移动物品，为新获得的物品腾出空间。";
...
CR_STURDINESS_TOOLTIP = "防止物品的耐久减少。";
...
DRUID_BALANCE_CORE_ABILITY_1 = "可用时，持续施加在目标身上。";
DRUID_BALANCE_CORE_ABILITY_2 = "可用时，持续施加在目标身上。";
DRUID_BALANCE_CORE_ABILITY_3 = "当太阳能量更强时使用。";
DRUID_BALANCE_CORE_ABILITY_4 = "当月亮能量更强时使用。";
DRUID_BALANCE_CORE_ABILITY_5 = "可用时使用，以提高星火术的伤害。";
DRUID_BALANCE_CORE_ABILITY_6 = "被动技能。使在月亮和太阳能量间轮转的法术变得更强大。";
DRUID_FERAL_CORE_ABILITY_1 = "持续施加在目标身上。";
DRUID_FERAL_CORE_ABILITY_2 = "用于积累连击点数。";
DRUID_FERAL_CORE_ABILITY_3 = "当你有5个连击点数时，持续施加在自己身上。";
DRUID_FERAL_CORE_ABILITY_4 = "当你有5个连击点数时，持续施加在目标身上。";
DRUID_FERAL_CORE_ABILITY_5 = "当你有5个连击点数并有其他终结技激活时使用。";
DRUID_GUARDIAN_CORE_ABILITY_1 = "可用时使用，可产生怒气。";
DRUID_GUARDIAN_CORE_ABILITY_2 = "持续施加在目标身上。";
DRUID_GUARDIAN_CORE_ABILITY_3 = "持续施加在目标身上。";
...
DRUID_RESTO_CORE_ABILITY_1 = "持续施加在主要治疗目标身上。";
...
ERR_ATTACK_PVP_TARGET_WHILE_UNFLAGGED = "你已关闭PVP了功能，不能对PVP目标这么做。";
...
ERR_MOUNT_NO_FAVORITES = "你没有有效的偏好坐骑。";
...
ERR_SET_LOOT_METHOD_FAILED_COMBAT = "修改拾取方式失败：小队成员正在战斗中。";
ERR_SET_LOOT_NBG = "分配方式设定为需求优先。";
ERR_SET_LOOT_PERSONAL = "将拾取方式设为个人拾取。";
...
FLIGHT_MAP = "飞行地图";
FLOATING_COMBATTEXT_LABEL = "浮动战斗信息t|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
FLOATING_COMBAT_PETBATTLE_LABEL = "宠物对战的浮动战斗记录|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
GARRISON_ABILITY_COUNTERS = "积分：";
GARRISON_ABILITY_COUNTERS_FORMAT = "数量：%s";
...
GARRISON_BOOT_TIMER = "该要塞不属于你或者你的队伍领袖。你将在%d %s后被传送出要塞。";
GARRISON_BUILD = "建造";
...
GARRISON_DISMISS_UNIQUE_FOLLOWER_CONFIRMATION = "你将永久解雇这名追随者。但你可以在某个NPC处重新获得这名追随者。决定要解雇%s吗？";
...
GARRISON_EMPTY_IN_PROGRESS_LIST = "你没有执行中的任务。";
...
GARRISON_EMPTY_PLOT_SELECTED_TOOLTIP = "将移动建筑拖曳到此空地。";
GARRISON_EMPTY_PLOT_SMALL = "小型空地";
GARRISON_FINALIZE_BUILDING = "完成建造";
GARRISON_FINALIZE_BUILDING_TOOLTIP = "返回你的建筑确定建造完成。";
...
GARRISON_FOLLOWER_EXHAUSTED = "恢复";
GARRISON_FOLLOWER_INACTIVE = "Inactive";
GARRISON_FOLLOWER_IN_PARTY = "在小队中";
...
GARRISON_LANDING_SHIPMENT_READY_TO_START = "%d准备起运";
...
GARRISON_LOCATION_TOOLTIP = "驻地";
GARRISON_LOCKED_PLOT_TOOLTIP = "完成任务以解锁该建筑";
GARRISON_MATERIAL_TOOLTIP = "[PH] Material Tooltip";
GARRISON_MAX_FOLLOWERS_CANNOT_RECRUIT = "你的追随者太多。在招募新追随者之前，你必须先解雇一些追随者。";
GARRISON_MAX_FOLLOWERS_MISSION_TOOLTIP = "你的追随者太多。在开始新任务之前，你必须先解雇一些追随者。";
GARRISON_MAX_FOLLOWERS_TOOLTIP = "你的追随者太多。在开始新任务或招募新追随者之前，你必须先解雇一些追随者。";
...
GARRISON_MISSION_COUNTER_FROM = "应对者：";
...
GARRISON_MISSION_TOOLTIP_NUM_REQUIRED_FOLLOWERS = "%d追随者任务";
...
GARRISON_MISSION_TUTORIAL6 = "绿色的钩表示已经消除了一个威胁。";
GARRISON_MISSION_TUTORIAL7 = "应对威胁，提高任务成功率。\n\n即使任务失败，依然能获得顶端所显示的基础经验值。";
GARRISON_MISSION_TUTORIAL8 = "追随者特长或建筑奖励可以略微提高任务的成功率或者其他队伍增益效果。";
GARRISON_MISSION_TUTORIAL9 = "当你组织好队伍之后，点击开始任务。";
...
GARRISON_REWARD_XP = "额外追随者经验";
GARRISON_REWARD_XP_FORMAT = "%s点经验值";
GARRISON_SHIPMENT_EMPTY = "等待货物";
GARRISON_SHIPMENT_READY = "货物准备就绪";
GARRISON_SPECIALIZATION_COOLDOWN = "无法将专精切换为%s。";
...
GARRISON_TOWN_HALL_ALLIANCE_UPGRADE_TIER1_TOOLTIP = "%s要求：%s影月谷的任务进度或达到93级。";
GARRISON_TOWN_HALL_ALLIANCE_UPGRADE_TIER2_TOOLTIP = "%s要求：%s100级。";
GARRISON_TOWN_HALL_EXPLANATION = "所有要塞活动的核心区域。你可以在这里找到你的建筑师和任务专员。";
GARRISON_TOWN_HALL_HORDE = "大厅";
GARRISON_TOWN_HALL_HORDE_UPGRADE_TIER1_TOOLTIP = "%s要求：%s霜火岭的任务进度或达到93级。";
GARRISON_TOWN_HALL_HORDE_UPGRADE_TIER2_TOOLTIP = "%s要求：%s100级。";
GARRISON_TOWN_HALL_LEVEL1_DESCRIPTION = "解锁一块大型和小型建筑用地。";
...
HUNTER_MM_CORE_ABILITY_2 = "可用时使用，尤其在打击2个目标时。";
HUNTER_MM_CORE_ABILITY_3 = "当你的集中值较低时使用。";
HUNTER_MM_CORE_ABILITY_4 = "当目标濒临死亡时使用。";
HUNTER_SV_CORE_ABILITY_1 = "持续施加在目标身上。";
...
ITEM_COMPARISON_SWAP_ITEM_MAINHAND_DESCRIPTION = "按%s在你的主手物品间切换。";
ITEM_COMPARISON_SWAP_ITEM_OFFHAND_DESCRIPTION = "按%s在你的副手物品间切换。";
...
ITEM_DELTA_DUAL_WIELD_COMPARISON_MAINHAND_DESCRIPTION = "（与你的主手装备|c%s%s|r相比)";
ITEM_DELTA_DUAL_WIELD_COMPARISON_OFFHAND_DESCRIPTION = "（与你的副手装备|c%s%s|r相比)";
...
ITEM_MOD_CR_STURDINESS_SHORT = "坚不可摧";
...
ITEM_MOD_CR_UNUSED_6_SHORT = "坚不可摧";
...
ITEM_NO_DROP = "无法丢弃";
ITEM_ONLY_TOURNAMENT_GEAR_ALLOWED = "本次战争游戏只能使用锦标赛装备。";
...
ITEM_TEXT_FROM = "发信人，";
ITEM_TOURNAMENT_GEAR = "锦标赛装备";
ITEM_TOURNAMENT_GEAR_WARNING = "锦标赛装备只能在战争游戏中使用。";
...
LEVEL_UP_RAID = "团队地下城已解锁！";
LEVEL_UP_RAID2 = "新团队地下城解锁：";
LEVEL_UP_SKILL_POINTS = "你还可以再学习%d个专业。";
LEVEL_UP_SPECIALIZATION_LINK = " |cffFF4E00|Htalentpane:|h[天赋专精]|h|r";
...
LFG_LIST_APP_INVITE_ACCEPTED = "加入";
...
LFG_LIST_ENTER_NAME = "显示在你队伍列表中的描述性名称";
...
LFG_LIST_FRIEND = "好友";
LFG_LIST_GROUP_FORMING = "你的队伍正在组织中。";
...
LFG_LIST_MUST_SIGN_UP_TO_WHISPER = "你必须发密语给队长才能申请加入这支队伍。";
LFG_LIST_NOTE_TO_LEADER = "队长的可选信息";
...
LFG_LIST_PROVING_TANK_SILVER = "|cffc0c0c0银级伤害承受者|r";
...
LFG_LIST_TOOLTIP_FRIENDS_IN_GROUP = "该队伍中的朋友：";
...
MAC_OPEN_UNIVERSAL_ACCESS1090 = "要想启用该选项，你必须在系统预设下的安全与隐私预设中授予%s相关权限。是否立刻开启系统预设？";
MAC_OPTIONS = "Mac设置";
MAC_OPTIONS_MISC = "杂项";
...
MAGE_FIRE_CORE_ABILITY_2 = "当情况紧急时使用。";
MAGE_FIRE_CORE_ABILITY_3 = "在出现爆击后使用，使炎爆术瞬发，或者扩散持续火焰伤害。";
MAGE_FIRE_CORE_ABILITY_4 = "用于在移动时造成伤害。";
MAGE_FIRE_CORE_ABILITY_5 = "在炎爆术后使用，提高持续火焰伤害。";
MAGE_FROST_CORE_ABILITY_1 = "主要的伤害法术。";
MAGE_FROST_CORE_ABILITY_2 = "当目标被冻结时使用。";
MAGE_FROST_CORE_ABILITY_3 = "当冰冷智慧出现时使用。";
...
MAINTANK = "主坦克";
MAIN_ASSIST = "主助理";
MAIN_HELP_BUTTON_TOOLTIP = "点击这里开启/关闭本窗口的帮助系统。";
MAIN_MENU = "设置";
MAIN_TANK = "主坦克";
MAJOR_GLYPH = "大型雕文";
MAJOR_GLYPHS = "大型雕文";
...
MONEY_COLON = "金钱：";
MONEY_LOOT = "金钱拾取";
MONK_BREW_CORE_ABILITY_1 = "可用时使用，可产生真气。";
MONK_BREW_CORE_ABILITY_2 = "用于生成真气。";
MONK_BREW_CORE_ABILITY_3 = "Use when you have 2 Chi to reduce damage.";
MONK_BREW_CORE_ABILITY_4 = "当没有其它技能可用时使用。";
MONK_BREW_CORE_ABILITY_5 = "当承受大量伤害时使用，消耗大量真气。";
...
MONK_MIST_CORE_ABILITY_5 = "当有多个队员伤害时使用。";
MONK_MIST_CORE_ABILITY_6 = "当许多受伤目标身上有你的复苏之雾时使用。";
MONK_WIND_CORE_ABILITY_1 = "用于生成真气。";
MONK_WIND_CORE_ABILITY_2 = "持续施加在自己身上。";
...
MOUNT_JOURNAL_NO_VALID_FAVORITES = "你尚未选择过适用于该区域的偏好坐骑。\n右键点击坐骑日志设置为偏好坐骑。";
...
NO_RESPONSE = "无回复";
NO_RF_AVAILABLE = "没有符合你当前等级的团队地下城可用。";
NO_RF_AVAILABLE_WITH_NEXT_LEVEL = "没有符合你当前等级的团队地下城可用。下一个团队地下城可在%d级时进入。";
...
NPE_ABILITYREMINDER_WARRIOR = "在攻击时，当你拥有足够的怒气时刻使用{$78}。 ";
...
NPE_ABILITYTRAININGDUMMY_WARRIOR = "在远处左键点击{$100}冲向你的目标。";
...
NPE_MAPCALLOUTBASE = "|TInterface\\WorldMap\\WorldMapArrow:28:28|t标记你的位置。\n\n";
...
NPE_NPCINTERACT = "|cFF00FFFF邮件点击|r{Atlas|NPE_RightClick:16}与任务要求的角色进行互动。";
...
NPE_QUESTREWARDCHOCIEREDITEMS = "你不能使用显示为|cFFFF0000红色|r的按钮。\n\n";
...
OBJECT_NPC_OUTLINE_MODE_ONE = "不显示";
OBJECT_NPC_OUTLINE_MODE_THREE = "鼠标悬停及目标";
OBJECT_NPC_OUTLINE_MODE_TWO = "仅限鼠标悬停（默认）";
OFF = "关";
OFFICER = "官员";
OFFICER_CHAT = "官员聊天";
...
OPTION_TOOLTIP_OBJECT_NPC_OUTLINE = "除任务目标外，目标轮廓也可以高亮显示鼠标悬停的物体和目标。";
...
OPTION_TOOLTIP_SHOW_HD_MODELS = "勾选此项显示全新的高清角色模型。";
...
PALADIN_PROT_CORE_ABILITY_4 = "当你有可用于治疗的神圣能量用时使用。";
...
PREVIOUS = "返回";
PRIEST_DISC_CORE_ABILITY_1 = "可用时使用，可治疗单个目标。";
...
PRIEST_SHADOW_CORE_ABILITY_1 = "持续施加在目标身上。";
PRIEST_SHADOW_CORE_ABILITY_2 = "持续施加在目标身上。";
...
QUEST_MONSTERS_KILLED = "已消灭%2$d/%3$d%1$s";
...
ROGUE_ASS_CORE_ABILITY_1 = "当离开潜行状态，发起战斗时使用。";
ROGUE_ASS_CORE_ABILITY_2 = "可用时使用。";
ROGUE_ASS_CORE_ABILITY_3 = "用于积累连击点数。";
ROGUE_ASS_CORE_ABILITY_4 = "当你有5个连击点数时，持续施加在自己身上。";
ROGUE_ASS_CORE_ABILITY_5 = "当你有5个连击点数时，持续施加在目标身上。";
ROGUE_ASS_CORE_ABILITY_6 = "当你有5个连击点数并有其他终结技激活时使用。";
ROGUE_COMBAT_CORE_ABILITY_1 = "当离开潜行状态，发起战斗时使用。";
ROGUE_COMBAT_CORE_ABILITY_2 = "持续施加在目标身上。";
ROGUE_COMBAT_CORE_ABILITY_3 = "用于积累连击点数。";
ROGUE_COMBAT_CORE_ABILITY_4 = "当你有5个连击点数时，持续施加在自己身上。";
ROGUE_COMBAT_CORE_ABILITY_5 = "当你有5个连击点数并有其他终结技激活时使用。";
ROGUE_SUB_CORE_ABILITY_1 = "当离开潜行状态，发起战斗时使用。";
ROGUE_SUB_CORE_ABILITY_2 = "持续施加在目标身上，用于在从正面攻击目标时累积连击点数。";
ROGUE_SUB_CORE_ABILITY_3 = "当不从正面发起攻击时使用，用于积累连击点数。";
ROGUE_SUB_CORE_ABILITY_4 = "当你有5个连击点数时，持续施加在自己身上。";
ROGUE_SUB_CORE_ABILITY_5 = "当你有5个连击点数时，持续施加在目标身上。";
ROGUE_SUB_CORE_ABILITY_6 = "当你有5个连击点数并有其他终结技激活时使用。";
ROLE = "职责";
...
SHADOW_ORBS_TOOLTIP = "由心灵震爆和暗言术：灭产生。可用于施放噬灵瘟疫或强化心灵惊骇。";
SHADOW_QUALITY = "阴影质量";
SHAMAN_ELE_CORE_ABILITY_1 = "持续施加在目标身上。";
...
SHAMAN_ENHANCE_CORE_ABILITY_1 = "持续施加在目标身上。";
SHAMAN_ENHANCE_CORE_ABILITY_2 = "可用时使用。";
SHAMAN_ENHANCE_CORE_ABILITY_3 = "可用时使用，可扩散烈焰震击。";
SHAMAN_ENHANCE_CORE_ABILITY_4 = "当漩涡武器瞬发时使用。";
SHAMAN_ENHANCE_CORE_ABILITY_5 = "可用时使用，可提高伤害。";
SHAMAN_ENHANCE_CORE_ABILITY_6 = "被动技能。使近战攻击降低自然法术的冷却时间。";
SHAMAN_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
SHAMAN_RESTO_CORE_ABILITY_1 = "持续施加在主要治疗目标身上。";
...
SLASH_RANDOM7 = "/roll";
SLASH_RANDOM8 = "/roll";
SLASH_RANDOMFAVORITEPET1 = "/随机最爱宠物";
...
SPELL_FAILED_BUILDING_ACTIVATE_NOT_READY = "该建筑还没不能激活。";
...
SPELL_FAILED_CUSTOM_ERROR_207 = "需要采矿或铸造达到600级。";
...
SPELL_FAILED_CUSTOM_ERROR_211 = "没有可供拾取的东西。";
...
SPELL_FAILED_CUSTOM_ERROR_238 = "已经激活了一头公牛。";
...
SPELL_FAILED_FOLLOWER_KNOWN = "你已经有追随者了。";
...
SPLASH_BASE_FEATURE1_DESC = "查看最新的玩具箱，背包功能升级以及材料银行。";
SPLASH_BASE_FEATURE1_TITLE = "界面功能";
SPLASH_BASE_FEATURE2_DESC = "排列和浏览各个地下城、团队地下城PVP及其他队伍。";
SPLASH_BASE_FEATURE2_TITLE = "预设队伍查找器";
...
SPLASH_BOOST_FEATURE1_DESC = "我们会赠送给你一套新装备，并将你的旧装备用邮件发送给你。";
SPLASH_BOOST_FEATURE1_TITLE = "我的物品去哪儿了？";
SPLASH_BOOST_FEATURE2_DESC = "你将在诅咒之地进行任务的过程中获得技能。";
SPLASH_BOOST_FEATURE2_TITLE = "技能";
SPLASH_BOOST_HEADER = "角色直升90级";
SPLASH_BOOST_LABEL = "关于角色直升90级的一些小提示";
...
TOURNAMENT_RULES_TOOLTIP = "勾选同意之后，参与者将只能使用锦标赛装备。其他装备将无法使用。";
TOWNSFOLK_TRACKING_TEXT = "镇民";
TOWN_HALL = "";
TOY = "玩具";
TOYBOX_FAVORITE_HELP = "右键点击收藏玩具。收藏的玩具将始终出现在首页。";
...
TRACK_QUEST_SORTING = "排列新近追踪的任务|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
VIDEO_OPTIONS_TEXTURE_DETAIL_FAIR = "中分辨率环境贴图，中等地貌细节，中分辨率角色贴图。";
VIDEO_OPTIONS_TEXTURE_DETAIL_HIGH = "高分辨率环境贴图，高地貌细节，高分辨率角色贴图。";
VIDEO_OPTIONS_TEXTURE_DETAIL_LOW = "低分辨率环境贴图，低地貌细节，低分辨率角色贴图。";
VIDEO_OPTIONS_TEXTURE_DETAIL_MEDIUM = "中分辨率环境贴图，中等地貌细节，中分辨率角色贴图。";
...
WARLOCK_AFFLICTION_CORE_ABILITY_1 = "持续施加在目标身上。";
WARLOCK_AFFLICTION_CORE_ABILITY_2 = "持续施加在目标身上。";
WARLOCK_AFFLICTION_CORE_ABILITY_3 = "持续施加在目标身上。";
...
WARLOCK_DEMO_CORE_ABILITY_1 = "持续施加在目标身上。";
WARLOCK_DEMO_CORE_ABILITY_2 = "当没有其它技能可用时使用。";
WARLOCK_DEMO_CORE_ABILITY_3 = "当熔火之心出现时使用。";
WARLOCK_DEMO_CORE_ABILITY_4 = "持续施加在目标身上，尤其当有多个目标时。";
WARLOCK_DEMO_CORE_ABILITY_5 = "当你的恶魔之怒全满时使用，变形成恶魔。";
WARLOCK_DEMO_CORE_ABILITY_6 = "被动技能。使你的灵魂之火有时能快速施放。";
WARLOCK_DESTRO_CORE_ABILITY_1 = "持续施加在目标身上。";
WARLOCK_DESTRO_CORE_ABILITY_2 = "可用时使用，可产生爆燃灰烬。";
WARLOCK_DESTRO_CORE_ABILITY_3 = "当需要消耗爆燃灰烬时使用。";
WARLOCK_DESTRO_CORE_ABILITY_4 = "当没有其它技能可用时使用。";
WARLOCK_DESTRO_CORE_ABILITY_5 = "当目标濒临死亡时使用，且你有爆燃灰烬时施放。";
WARLOCK_INTELLECT_TOOLTIP = "提高你的法力值上限和法术的爆击几率。\n使你更快地提升武器技能熟练度。";
WARRIOR_ARMS_CORE_ABILITY_1 = "当发起战斗时使用，使怒气全满。";
WARRIOR_ARMS_CORE_ABILITY_2 = "可用时使用，让目标承受更多伤害。";
WARRIOR_ARMS_CORE_ABILITY_3 = "可用时使用。最强的打击技能。";
WARRIOR_ARMS_CORE_ABILITY_4 = "持续施加在目标身上。";
WARRIOR_ARMS_CORE_ABILITY_5 = "当你需要消耗怒气且没有其他技能可用时使用。";
WARRIOR_ARMS_CORE_ABILITY_6 = "当目标濒临死亡时使用。";
WARRIOR_FURY_CORE_ABILITY_1 = "当发起战斗时使用，使怒气全满。";
WARRIOR_FURY_CORE_ABILITY_2 = "可用时使用。是主要的怒气生成手段。";
WARRIOR_FURY_CORE_ABILITY_3 = "可用时使用，让目标承受更多伤害。";
WARRIOR_FURY_CORE_ABILITY_4 = "可用时使用。";
WARRIOR_FURY_CORE_ABILITY_5 = "当无需消耗或需要消耗怒气时使用。";
WARRIOR_FURY_CORE_ABILITY_6 = "当目标濒临死亡时使用。";
WARRIOR_PROT_CORE_ABILITY_1 = "当发起战斗时使用，使怒气全满。";
...
WORLD_MAP_TUTORIAL2 = "此处将你在当前地图的任务。\n\n你也可以右键点击缩小地图（这不会影响你查看任务细节）。";
WORLD_MAP_TUTORIAL3 = "点击该按钮查看你所有的任务。";
WORLD_MAP_TUTORIAL4 = "你可以使用下拉菜单快速切换地图。你还可以点击“世界”按钮查看你所有的任务。";
